          ...
          <div class="field-wrap" dir="rtl">
            ...
            <input type="text"required autocomplete="off"/>
                            ...
                            <div class="field-wrap">
                                ...
                                <input type="password" name="confirmpwd" id="confirmpwd" required autocomplete="off" />
                            </div>
                            <button type="submit" class="button button-block" value="Register" onclick="return regformhash(this.form,
                                   this.form.username,
                                   this.form.email,
                                   this.form.password,
