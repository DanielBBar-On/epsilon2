...
include_once '../includes/courses/functions.php';
  ...
  $db = new mysqli(constant("HOST"), constant("USER"), 
  				   constant("PASSWORD"), constant("DATABASE")); //set your database handler
...
<div>
  ...
  <body id="index_body" style="width:100%; height:100%;" onload='loadCategories()'>
    ...
    <div style="float:right; width:20%; height:100vh; margin:auto;">
    	<div>
        	<a  href="registrationFull.php"
            	style="margin-top:50px;" type="submit" class="button2" name="action" 
                id="upload_submit">התחברות/הרשמה</a>
        </div>
      ...
      <div id="upload_div" style="height:inherit;">
        <form action="php/upload_form/ajax.php" method="post" enctype="multipart/form-data" 
        				style="height:inherit; text-align:center; margin-top:0%; width:100%; height:100%;">
          <!-- user title -->
          ...
          <input style="margin-top:50px" type="submit" class="button2" name="action" id="upload_submit" value="חיפוש" />
        </form><br>
      </div>
    </div>
